...
typedef struct __attribute__((__packed__)) OPLOperatorData {
    uint8_t avekm = 0x21; // 0x20-0x35: AM/VIB/EGT/KSR/MULT
    uint8_t ksl_tl = 0x3f; // 0x40-0x55: KSL/TL
    uint8_t ar_dr = 0xf0; // 0x60-0x75: AR/DR
    uint8_t sl_rr = 0xff; // 0x80-0x95: SL/RR
    uint8_t ws = 0x00; // 0xe0-0xf5: WS
} OPLOperatorData;
